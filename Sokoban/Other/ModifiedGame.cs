...
namespace Sokoban.Other {
    public class ModifiedGameModel : ModifiedIGame {
        [DebuggerDisplay("{X},{Y}")]
        ...
        public void SetView(OtherPersonsIGameView view) { this.view = view; }
        ...
        private void Update(params Vector2[] posList) {
            ...
            //    this.view.Congraz();
            //}
            this.view.RedrawLevel();
            if (IsWin()) {
                this.view.DisplaySystemMessage("You win!");
            }
        }
